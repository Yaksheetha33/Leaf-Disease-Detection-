...
training_set = train_datagen.flow_from_directory('E:\\Project Codes\\drive-download 1\\Plant-Leaf-Disease-Prediction-main\\Plant-Leaf-Disease-Prediction-main\\Dataset\\train', # relative path from working directoy
                                                 target_size = (128, 128),
                                                 batch_size = 6, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory('E:\\Project Codes\\drive-download 1\\Plant-Leaf-Disease-Prediction-main\\Plant-Leaf-Disease-Prediction-main\\Dataset\\val', # relative path from working directoy
                                             target_size = (128, 128), 
