...
filepath = 'C:\\Users\\police\\Desktop\\Plant-Leaf-Disease-Prediction-main\\model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('C:\\Users\\police\\Desktop\\Plant-Leaf-Disease-Prediction-main\\Dataset\\test\\Tomato___Bacterial_spot (1).JPG')
